		...
		public override void Draw(GameTime gameTime)
		{
			...
			if (gameState == GameStateSecurity.Play || gameState == GameStateSecurity.Guess)
			{
				...
				if (gameState == GameStateSecurity.Guess) 
				{
					...
					if (showText)
					{
						spriteBatch.DrawString(font, "GUESSING TIME!!! " + chosenChildPosition , new Vector2(graphics.Viewport.Width / 2 - 250, 50), Color.White);
					}
				}
			...
			spriteBatch.DrawString(font, "Score: " + score, new Vector2(graphics.Viewport.Width - 450, 50), Color.White);
